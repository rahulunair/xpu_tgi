...
**What is it?**  
The Phi-3-mini-4k-instruct is a 3.8 billion parameter model developed by Microsoft. It's designed for instruction-following tasks with a context window of up to 4,000 tokens. This model excels in tasks requiring high-quality reasoning and understanding.
...
**License:**  
Check the license and terms of use on [Hugging Face](https://huggingface.co/microsoft/Phi-3-mini-4k-instruct). Ensure compliance before using!
